...
BLOCKPATH = '/Users/brandon/My Drive (bloliv95@gmail.com)/wheel-peak-test/tanks/DA80_VEH_11_29_2022';
...
MAD1 = mad(DLS_trimmed_smooth,1);
MAD2 = mad(NAC_trimmed_smooth,1);
RMS1 = rms(DLS_trimmed_smooth);
RMS2 = rms(NAC_trimmed_smooth);
