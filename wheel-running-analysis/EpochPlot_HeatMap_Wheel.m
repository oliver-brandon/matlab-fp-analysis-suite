...
BLOCKPATH = '/Volumes/CUDADRIVE/eCB Wheel Harrison & Alex/tanks/1463_Wheel1_EMPTY Scored'; % path to TDT data tank (folder containing TDT data)
channel = 1; % 1 = mouse on A channel, 2 = mouse on C channel
camNumber = 2;
REF_EPOC = 'runStart'; % Stimulation event to center on
...
%combine index with timestamp data from Cam1 or Cam2 notes%
if camNumber == 1
